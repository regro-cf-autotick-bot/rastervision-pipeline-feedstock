...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rastervision-pipeline-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13337&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rastervision-pipeline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rastervision-pipeline` can be installed with:

```
conda install rastervision-pipeline
```

It is possible to list all of the versions of `rastervision-pipeline` available on your platform with:
